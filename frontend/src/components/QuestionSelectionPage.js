...
function QuestionSelectionPage(props) {
    ...
    return (
            <Box>
                ...
                <Box display={"flex"} flexDirection={"row"} justifyContent={"center"} gap={6} alignItems={"center"} sx={{ 'button': { m: 1 } }}>
                ...
                <BackSide style={{ backgroundColor: '#b3ffcc'}} onClick={() => props.handleMatching("EASY")}>
                <br></br>
                ...
                <BackSide style={{ backgroundColor: '#ffbf80'}} onClick={() => props.handleMatching("MEDIUM")}>
                <br></br>
                ...
                <BackSide style={{ backgroundColor: '#ff8080'}} onClick={() => props.handleMatching("HARD")}>
                <br></br>
